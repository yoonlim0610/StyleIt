...
public class imgPaging {
	...
	// 총 게시글 수만 입력하는 생성자
	public imgPaging(int totalCount) {
	...
	public imgPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public imgPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public imgPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	private void makePaging() {
		...
		if(listCount == 0) setListCount(40); // 게시글 10개로 설정
