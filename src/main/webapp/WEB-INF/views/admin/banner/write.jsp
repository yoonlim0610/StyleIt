...
<%--  <jsp:include page="/tiles/layout/header.jsp" /> --%>
...
<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#btnFile").click(function() {
				...
				//팝업 url 설정
				popup.location = "/admin/banner/write";
			});
		});
...
<%--   <jsp:include page="/tiles/layout/sidebar.jsp" /> </div> --%>
...
<form action="/admin/banner/write" method="post"
 class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-sm-5">
		<input type="text" id="" name="number" value="${bannerview.b_no }"
			class="form-control"/>
		</div>
	</div>

  <div class="col-sm-offset-4">
	<button type="button" id="btnSub" class="btn btn-sm" style="color:white; background:black;">등록</button>
	<button type="button" id="btnCancel" class="btn btn-sm" style="color:white; background:red;">취소</button>
	</div>
...
<%-- <jsp:include page="/tiles/layout/footer.jsp" /> --%>
</div>
